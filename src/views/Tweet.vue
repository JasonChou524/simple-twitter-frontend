        ...
        <div class="tweet">
          ...
          <div class="tweet-detail">
            ...
            <div class="footer">
              ...
              <div v-else class="like-btn" @click="addLike(tweet.id)">
                <svg width="30" height="30" viewBox="0 0 30 30">
                  <path
...
export default {
  ...
  created() {
    this.$store.dispatch('fetchTweet', dummyTweetId)
  },
  methods: {
    addLike(tweetId) {
      this.$store.dispatch('fetchAddLike', tweetId)
    },
    removeLike(tweetId) {
      this.$store.dispatch('fetchRemoveLike', tweetId)
    }
  }
}
</script>
