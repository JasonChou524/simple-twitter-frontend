  ...
  methods: {
    ...
    async fetchUserFollowings(id) {
      try {
        ...
        this.userFollowings = data.map((userFollowing) => ({
          id: userFollowing.followingId,
          avatar: userFollowing.followingAvatar,
          name: userFollowing.followingName,
          introduction: userFollowing.followingIntroduction,
          isFollow: userFollowing.isFollowing
        }))
    ...
    afterAddFollow(id) {
      this.userFollowings = this.userFollowings.map((user) => {
        if (user.id === id) {
          return {
            ...user,
            isFollow: true
